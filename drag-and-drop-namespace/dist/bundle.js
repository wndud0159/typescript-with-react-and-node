...
var App;
(function (App) {
    function Authbind(_, _2, descriptor) {
    ...
    App.Authbind = Authbind;
})(App || (App = {}));
var App;
(function (App) {
    function validate(vaildatableInput) {
        let isValid = true;
...
(function (App) {
    class ProjectInput extends App.Component {
        ...
        gatherUserInput() {
            ...
            if (!App.validate(titleVaildatable) || !App.validate(descriptionVaildatable) || !App.validate(peopleVaildatable)) {
